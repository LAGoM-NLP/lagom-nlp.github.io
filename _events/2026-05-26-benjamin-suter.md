...
title: "Shaping Cross-Lingual Transfer: Input Representation as an Inductive Bias"
abstract: Low-resource languages rely heavily on cross-lingual transfer, yet it remains unclear which properties enable successful transfer across languages. While sharing happens in all layers of a model, the way language is represented at the input level (e.g. through tokenization) acts as an inductive bias, defining the units a model will operate on and shaping what it can immediately recognize as similar or different.<br/>
Current tokenizers operate directly on the surface, and indeed, empirical evidence suggests that multilingual transfer is sensitive to spelling and script variation. Ideally, however, what is shared in a model across languages is structural similarity, not surface overlap.<br/>
...
speaker: ‏Benjamin Suter
# bio: 
website: https://scholar.google.com/citations?user=Sga8C1MAAAAJ&hl=en
date: May 26, 2026
time: 15:00–16:00
